...
% =========================================================================
% Description: 
%  Integrate the Ejima equation (eqn B.4 in gspulse_algorithm.pdf) to find
...
%    1/2 Li * Ip^2 is used in eqn B.4. 
% =========================================================================
% get time info
dt = mean(diff(t0N));
t = t0N(2:end);
...
ref = structts2struct(shapes, fieldnames(shapes), t0);
psibry0 = mean(bicubicHermite(tok.rg, tok.zg, eqs0N{1}.psizr, ref.rbdef, ref.zbdef));
